<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa fa-dot-circle-o fa-fw"></i> Thể loại<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/loai/danhsach">Danh sách</a>
                    </li>
                    <li>
                        <a href="admin/loai/them">Thêm</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                <a href="#"><i class="fa fa fa-edit fa-fw"></i> Tác giả<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/tacgia/danhsach">Danh sách</a>
                    </li>
                    <li>
                        <a href="admin/tacgia/them">Thêm</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                <a href="#"><i class="fa fa-hacker-news fa-fw"></i> Tin tức<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="#"><i class="fa fa-file-picture-o fa-fw"></i> Slide<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart fa-fw"></i> Thống kê</a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/thongke/doanhthu">Doanh thu</a>
                    </li>
                    <li>
                        <a href="admin/thongke/sanpham">Sản phẩm đã bán</a>
                    </li>
                </ul>
            </li>
        </ul>
